    ...
    <footer id="footer" class="footer">
        <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <aside class="footer__top__nav footer__top__nav--contact">
                            <h3>{{__('Contact Us')}}</h3>
                            <p>{{__('Email: enquiry@indiadhundo.com')}}</p>
                            <p>{{__('Phone: (91) 9755996968')}}</p>
                            <ul>
                                <li>
            ...
            <div class="footer__bottom">
                <p class="footer__bottom__copyright">{{now()->year}} &copy; <a href="{{__('https://indiadhundo.com/')}}" target="_blank">{{__('IndiaDhundo')}}</a>. {{__('All rights reserved.')}}</p>
            </div><!-- .top-footer -->
        </div><!-- .container -->
    </footer><!-- site-footer -->
</div><!-- #wrapper -->
